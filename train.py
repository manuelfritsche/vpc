...
parser.add_argument('-e', '--env-id', type=str, default="mazeSmall-v0",
                    help="Environment id")
parser.add_argument('-l', '--log-dir', type=str, default="tmp/vpc",
...
parser.add_argument('--unsup', type=str, default=None,
                    help="Unsup. exploration mode: pred or vpc or None")
...
def create_commands(session, num_workers, remotes, env_id, logdir, shell='bash',
                    mode='tmux', visualise=False, unsup=None, psPort=12222,
...
def run():    
    ...
    cmds, notes = create_commands(args.expName, args.num_workers, args.remotes, args.env_id,
                                    ...
                                    unsup=args.unsup, psPort=psPort, delay=delay, 
                                    savio=args.savio, pretrain=args.pretrain)
    if args.dry_run:
