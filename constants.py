...
'PREDICTION_BETA': 0.0005,  # weight of prediction bonus
                          # set 0.5 for unsup=state
'PREDICTION_LR_SCALE': 0.01,  # scale lr of predictor wrt to policy network
...
'USE_VPC_SMOOTHING': False, # True if the smoothing function should be used
'SMOOTHING_VALUE': 1, # constant used in weighting function
'VPC_WT': 0.1, # weight for value prediction regularization term
}
